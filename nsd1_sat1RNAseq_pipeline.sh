...
featureCounts -p -B -M -O -g transcript_id -a danRer11.repeatmsk.gtf.gz -o repeat_alignment.txt n1_alignment.sam n2_alignment.sam n3_alignment.sam wt1_alignment.sam wt2_alignment.sam wt3_alignment.sam
