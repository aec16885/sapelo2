...
cuffdiff -o differential_cufflinks_output/ n1_alignment.sorted.sam,n2_alignment.sorted.sam,n3_alignment.sorted.sam wt1_alignment.sorted.sam,wt2_alignment.sorted.sam,wt3_alignment.sorted.sam
